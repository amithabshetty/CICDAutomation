...
public class SubmitOrderTest_JSONData extends BaseTests {
	...
	//Call method to get JSON data -> getJsonDataToMap() method is placed in Base Tests so no object is required to call that method is here as BaseTest Calse is extended her
	 ...
	 * 
	 * return new Object[][] {{"ami.selenium@abc.com","Selenium123","ZARA COAT 3"},
	 * {"samy.selenium@abc.com","Password123","ADIDAS ORIGINAL"}};
			/*
			 * HashMap<String,String> map = new HashMap<String,String>();
			 * map.put("email","ami.selenium@abc.com"); map.put("password","Selenium123");
			 * map.put("product", "ZARA COAT 3");
			 * 
			 * 
			 * HashMap<String,String> map1 = new HashMap<String,String>();
			 * map1.put("email","samy.selenium@abc.com"); map1.put("password","Password");
